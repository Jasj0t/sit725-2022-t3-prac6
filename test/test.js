...
describe("Add Two Numbers", function(){
  var url = "http://localhost:1336/addTwoNumbers/3/5"
  //Test1
  it("returns satus 200 to check if api works", function(done){
  ...
  //Test 7
  it("retruns statuscode key in body to check if api gives right result, should be 400", function(done){
    request(url, function(error, response, body){
      body = JSON.parse(body)
